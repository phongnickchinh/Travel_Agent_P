...
Categories use Google Places API types (Table A):
...
MOCK_POIS_DA_NANG: List[Dict[str, Any]] = [
    ...
    # CULTURAL & TEMPLES
    {
        ...
        "categories": ["hindu_temple", "tourist_attraction", "historical_landmark"],
    ...
    },
    {
        ...
        "categories": ["historical_landmark", "tourist_attraction", "hiking_area"],
    ...
    # NATURE & OUTDOOR
    {
        ...
        "categories": ["park", "hiking_area", "tourist_attraction"],
    ...
    # MARKETS & SHOPPING
    {
        ...
        "name": "Chợ Hàn",
        "name_en": "Han Market",
        "categories": ["market", "shopping_mall", "restaurant"],
    ...
    # FOOD & DINING
    {
        ...
        "categories": ["restaurant", "fast_food_restaurant"],
    ...
    },
    {
        ...
        "categories": ["market", "restaurant", "night_club"],
    ...
    # SPIRITUAL & RELIGIOUS
    {
        ...
        "categories": ["hindu_temple", "tourist_attraction"],
